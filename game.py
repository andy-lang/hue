    ...
    def main(self):
        ...
        while self.running:
            if self.state == 0:
                ...
                titleFont = pygame.font.SysFont("monospace", 36)
                titleText = titleFont.render("Hue.", 1, (255, 0, 0))

                instrFont = pygame.font.SysFont("monospace", 24)
                instrText = instrFont.render("Press Space to begin.", 1, (0, 0, 0))
                self.screen.blit(titleText, (self.width/2 - titleText.get_rect().width/2, self.height/4))
                self.screen.blit(instrText, (self.width/2 - instrText.get_rect().width/2, 3*self.height/4))
